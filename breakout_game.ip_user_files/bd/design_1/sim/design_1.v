...
module design_1
   (DDR_addr,
    ...
    FIXED_IO_ps_srstb,
    btns_4bits_tri_i,
    hdmi_out_0_tmds_clk_n,
    hdmi_out_0_tmds_clk_p,
    hdmi_out_0_tmds_data_n,
    hdmi_out_0_tmds_data_p);
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:hdmi:2.0 hdmi_out_0 TMDS_CLK_N" *) output hdmi_out_0_tmds_clk_n;
  (* X_INTERFACE_INFO = "xilinx.com:interface:hdmi:2.0 hdmi_out_0 TMDS_CLK_P" *) output hdmi_out_0_tmds_clk_p;
  (* X_INTERFACE_INFO = "xilinx.com:interface:hdmi:2.0 hdmi_out_0 TMDS_DATA_N" *) output [2:0]hdmi_out_0_tmds_data_n;
  (* X_INTERFACE_INFO = "xilinx.com:interface:hdmi:2.0 hdmi_out_0 TMDS_DATA_P" *) output [2:0]hdmi_out_0_tmds_data_p;

  wire [3:0]axi_gpio_0_GPIO_TRI_I;
  wire clk_wiz_0_pixelclock;
  wire clk_wiz_0_serialclock;
  wire [23:0]objectbuffer_0_rgb;
  ...
  wire rgb2tmds_0_hdmi_out_TMDS_CLK_N;
  wire rgb2tmds_0_hdmi_out_TMDS_CLK_P;
  wire [2:0]rgb2tmds_0_hdmi_out_TMDS_DATA_N;
  wire [2:0]rgb2tmds_0_hdmi_out_TMDS_DATA_P;
  ...
  wire vtg_0_hsync;
  wire [15:0]vtg_0_pixel_x;
  wire [15:0]vtg_0_pixel_y;
  wire vtg_0_video_active;
  wire vtg_0_vsync;

  assign axi_gpio_0_GPIO_TRI_I = btns_4bits_tri_i[3:0];
  assign hdmi_out_0_tmds_clk_n = rgb2tmds_0_hdmi_out_TMDS_CLK_N;
  assign hdmi_out_0_tmds_clk_p = rgb2tmds_0_hdmi_out_TMDS_CLK_P;
  assign hdmi_out_0_tmds_data_n[2:0] = rgb2tmds_0_hdmi_out_TMDS_DATA_N;
  assign hdmi_out_0_tmds_data_p[2:0] = rgb2tmds_0_hdmi_out_TMDS_DATA_P;
  ...
  design_1_objectbuffer_0_0 objectbuffer_0
       (.pixel_x(vtg_0_pixel_x),
        .pixel_y(vtg_0_pixel_y),
        .rgb(objectbuffer_0_rgb),
  ...
  design_1_rgb2tmds_0_0 rgb2tmds_0
       (.clk_n(rgb2tmds_0_hdmi_out_TMDS_CLK_N),
        .clk_p(rgb2tmds_0_hdmi_out_TMDS_CLK_P),
        .data_n(rgb2tmds_0_hdmi_out_TMDS_DATA_N),
        .data_p(rgb2tmds_0_hdmi_out_TMDS_DATA_P),
        .hsync(vtg_0_hsync),
        .pixelclock(clk_wiz_0_pixelclock),
        .rst(proc_sys_reset_0_peripheral_reset),
        .serialclock(clk_wiz_0_serialclock),
        .video_active(vtg_0_video_active),
        .video_data(objectbuffer_0_rgb),
        .vsync(vtg_0_vsync));
