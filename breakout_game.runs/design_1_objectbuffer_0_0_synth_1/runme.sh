...
HD_PWD='F:/FPGA-Proje/Proje_new/breakout_game/breakout_game.runs/design_1_objectbuffer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_objectbuffer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_objectbuffer_0_0.tcl
